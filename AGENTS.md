...
3. The test suites that matter are:
   ...
   - `frontend/tests/e2e/*.spec.mjs` (~60 tests, including 16 the SSH integration
...
The repo also contains earlier screenshot output (`*_frames/`, `gemini_tui_*.png`),
...
patterns and produced the earlier screenshot output and ~50 abandoned spec files
still in the repo.

- **Screenshot-driven verification**: capturing hundreds of screenshots
